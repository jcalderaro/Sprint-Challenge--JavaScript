...
zooAnimals.forEach(function(param) {
  displayNames.push(`Name: ${param.animal_name}, Scientific: ${param.scientific_name}`)
});
...
let lowerCaseAnimalNames = [];
lowerCaseAnimalNames = zooAnimals.map(function(param){
...
lowPopulationAnimals = zooAnimals.filter(function(param){
